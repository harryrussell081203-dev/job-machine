...
# links that let anybody in at all. mail.jobmachine.co.uk can be burned and
# replaced; jobmachine.co.uk cannot.
...
# degrade politely - it rejects. Every user sending from a Job Machine
